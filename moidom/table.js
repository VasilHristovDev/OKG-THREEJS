class Table {
  ...
  getObject() {
    ...
    const clothMaterial = new THREE.MeshStandardMaterial({color: 0xff12412 ,map: textureLoader.load("../materials/blanket.jpg")});
    ...
    bottomLeftLeg.position.set(this.width/2 - 0.05, -0.4, this.depth/2 - 0.05);
    bottomRightLeg.position.set(this.width/2 - 0.05, -0.4, -this.depth/2 + 0.05);
    topLeftLeg.position.set(-this.width/2 + 0.05, -0.4, this.depth/2 - 0.05);
    topRightLeg.position.set(-this.width/2 + 0.05, -0.4, -this.depth/2 + 0.05);
